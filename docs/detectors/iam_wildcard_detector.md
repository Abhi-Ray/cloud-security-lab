# Add IAM Wildcard Policy Detector for Overly Permissive Roles
...
This document covers the essential aspects of add iam wildcard policy detector for overly permissive roles.
