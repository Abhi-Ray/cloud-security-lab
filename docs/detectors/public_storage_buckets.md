# Add detector for publicly accessible cloud storage buckets
...
This document covers the essential aspects of add detector for publicly accessible cloud storage buckets.
