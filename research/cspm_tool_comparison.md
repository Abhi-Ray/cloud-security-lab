# Compare cloud CSPM tools

> Auto-generated by Cloud Security Lab Agent

## Overview

Evaluate Prowler, ScoutSuite, CloudSploit, and Steampipe for CSPM coverage,
    extensibility, and CI/CD integration.
...
This document covers the essential aspects of compare cloud cspm tools.
