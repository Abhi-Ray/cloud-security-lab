"""Tests for Add EKS cluster security scanner."""

from __future__ import annotations


class TestEksClusterSecurityScanner:
    """Unit tests for EksClusterSecurityScanner."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from security_scanner.scanners.eks_scanner import EksClusterSecurityScanner

        scanner = EksClusterSecurityScanner()
        config = {
