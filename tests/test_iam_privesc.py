"""Tests for Add IAM privilege escalation detector."""

from __future__ import annotations


class TestIamPrivilegeEscalationDetector:
    """Unit tests for IamPrivilegeEscalationDetector."""

    def test_detects_high_risk_action(self) -> None:
        """High-risk API call should generate an alert."""
        from detectors.rules.iam_privesc import IamPrivilegeEscalationDetector

        detector = IamPrivilegeEscalationDetector()
        events = [
            {
