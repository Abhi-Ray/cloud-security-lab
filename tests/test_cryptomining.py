"""Tests for Add crypto-mining activity detector."""

from __future__ import annotations


class TestCryptoMiningActivityDetector:
    """Unit tests for CryptoMiningActivityDetector."""

    def test_detects_high_risk_action(self) -> None:
        """High-risk API call should generate an alert."""
        from detectors.rules.cryptomining import CryptoMiningActivityDetector

        detector = CryptoMiningActivityDetector()
        events = [
            {
