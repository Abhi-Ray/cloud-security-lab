"""Tests for Add SARIF output support for security scanner."""

from __future__ import annotations


class TestSarifOutputSupportSecurityScanner:
    """Unit tests for SarifOutputSupportSecurityScanner."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from security_scanner.formatters.sarif_formatter import SarifOutputSupportSecurityScanner

        scanner = SarifOutputSupportSecurityScanner()
        config = {
