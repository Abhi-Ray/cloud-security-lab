"""Tests for Add SBOM Generation and Vulnerability Correlation."""

from __future__ import annotations


class TestSbomGenerationAndVulnerabilityCorrelation:
    """Unit tests for SbomGenerationAndVulnerabilityCorrelation."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from security_scanner.sbom.vuln_correlator import SbomGenerationAndVulnerabilityCorrelation

        scanner = SbomGenerationAndVulnerabilityCorrelation()
        config = {
