"""Tests for Add SARIF Output Format to Security Scanner."""

from __future__ import annotations


class TestSarifOutputFormatToSecurityScanner:
    """Unit tests for SarifOutputFormatToSecurityScanner."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from security_scanner.reporting.sarif_reporter import SarifOutputFormatToSecurityScanner

        scanner = SarifOutputFormatToSecurityScanner()
        config = {
