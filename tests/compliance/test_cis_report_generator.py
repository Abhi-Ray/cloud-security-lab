"""Tests for Add CIS AWS Foundations Benchmark v1.5.0 compliance mapping."""

from __future__ import annotations


class TestCisAwsFoundationsBenchmarkV150ComplianceMapping:
    """Unit tests for CisAwsFoundationsBenchmarkV150ComplianceMapping."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from compliance.reporting.cis_report_generator import (
            CisAwsFoundationsBenchmarkV150ComplianceMapping,
        )

        scanner = CisAwsFoundationsBenchmarkV150ComplianceMapping()
        config = {
