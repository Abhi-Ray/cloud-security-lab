"""Tests for Add Multi-Cloud Public Storage Bucket Detector."""

from __future__ import annotations


class TestMultiCloudPublicStorageBucketDetector:
    """Unit tests for MultiCloudPublicStorageBucketDetector."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from detectors.public_storage_bucket_detector import MultiCloudPublicStorageBucketDetector

        scanner = MultiCloudPublicStorageBucketDetector()
        config = {
