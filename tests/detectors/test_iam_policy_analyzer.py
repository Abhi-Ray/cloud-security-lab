"""Tests for Add IAM Policy Analyzer Detector for Overly Permissive Roles."""

from __future__ import annotations


class TestIamPolicyAnalyzerDetectorOverlyPermissiveRoles:
    """Unit tests for IamPolicyAnalyzerDetectorOverlyPermissiveRoles."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from detectors.iam_policy_analyzer import IamPolicyAnalyzerDetectorOverlyPermissiveRoles

        scanner = IamPolicyAnalyzerDetectorOverlyPermissiveRoles()
        config = {
