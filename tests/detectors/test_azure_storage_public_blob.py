"""Tests for Add detector for publicly accessible Azure Storage Account blob containers."""

from __future__ import annotations


class TestDetectorPubliclyAccessibleAzureStorageAccountBlobContainers:
    """Unit tests for DetectorPubliclyAccessibleAzureStorageAccountBlobContainers."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from detectors.azure_storage_public_blob import (
            DetectorPubliclyAccessibleAzureStorageAccountBlobContainers,
        )

        scanner = DetectorPubliclyAccessibleAzureStorageAccountBlobContainers()
        config = {
