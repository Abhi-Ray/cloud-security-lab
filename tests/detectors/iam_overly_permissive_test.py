"""Tests for Add IAM Overly Permissive Policy Detector."""

from __future__ import annotations


class TestIamOverlyPermissivePolicyDetector:
    """Unit tests for IamOverlyPermissivePolicyDetector."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from detectors.iam_overly_permissive import IamOverlyPermissivePolicyDetector

        scanner = IamOverlyPermissivePolicyDetector()
        config = {
