"""Tests for Add S3 Bucket Public Access Detector."""

from __future__ import annotations


class TestS3BucketPublicAccessDetector:
    """Unit tests for S3BucketPublicAccessDetector."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from detectors.aws.s3_public_access import S3BucketPublicAccessDetector

        scanner = S3BucketPublicAccessDetector()
        config = {
