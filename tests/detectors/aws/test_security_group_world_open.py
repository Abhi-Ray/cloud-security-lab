"""Tests for Add detector for security groups allowing ingress from 0.0.0.0/0."""

from __future__ import annotations


class TestDetectorSecurityGroupsAllowingIngressFrom00000:
    """Unit tests for DetectorSecurityGroupsAllowingIngressFrom00000."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from detectors.aws.security_group_world_open import (
            DetectorSecurityGroupsAllowingIngressFrom00000,
        )

        scanner = DetectorSecurityGroupsAllowingIngressFrom00000()
        config = {
