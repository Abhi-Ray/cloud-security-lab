"""Tests for Add AWS Security Group Unrestricted Ingress Detector."""

from __future__ import annotations


class TestAwsSecurityGroupUnrestrictedIngressDetector:
    """Unit tests for AwsSecurityGroupUnrestrictedIngressDetector."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from detectors.aws.security_group_unrestricted_ingress import (
            AwsSecurityGroupUnrestrictedIngressDetector,
        )

        scanner = AwsSecurityGroupUnrestrictedIngressDetector()
        config = {
