"""Tests for Add detector for publicly accessible AWS RDS instances."""

from __future__ import annotations


class TestDetectorPubliclyAccessibleAwsRdsInstances:
    """Unit tests for DetectorPubliclyAccessibleAwsRdsInstances."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from detectors.aws.rds import DetectorPubliclyAccessibleAwsRdsInstances

        scanner = DetectorPubliclyAccessibleAwsRdsInstances()
        config = {
