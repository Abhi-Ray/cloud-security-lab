"""Tests for Add IAM Wildcard Policy Detector for Overly Permissive Roles."""

from __future__ import annotations


class TestIamWildcardPolicyDetectorOverlyPermissiveRoles:
    """Unit tests for IamWildcardPolicyDetectorOverlyPermissiveRoles."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from detectors.iam_wildcard_detector import IamWildcardPolicyDetectorOverlyPermissiveRoles

        scanner = IamWildcardPolicyDetectorOverlyPermissiveRoles()
        config = {
