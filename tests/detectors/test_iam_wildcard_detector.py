"""Tests for Add detector for IAM policies with wildcard permissions."""

from __future__ import annotations


class TestDetectorIamPoliciesWildcardPermissions:
    """Unit tests for DetectorIamPoliciesWildcardPermissions."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from detectors.iam_wildcard_detector import DetectorIamPoliciesWildcardPermissions

        scanner = DetectorIamPoliciesWildcardPermissions()
        config = {
