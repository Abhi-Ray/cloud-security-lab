"""Tests for Add detector for publicly exposed cloud storage buckets."""

from __future__ import annotations


class TestDetectorPubliclyExposedCloudStorageBuckets:
    """Unit tests for DetectorPubliclyExposedCloudStorageBuckets."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from detectors.storage.public_bucket_detector import (
            DetectorPubliclyExposedCloudStorageBuckets,
        )

        scanner = DetectorPubliclyExposedCloudStorageBuckets()
        config = {
