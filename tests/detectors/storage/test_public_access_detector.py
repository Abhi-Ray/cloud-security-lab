"""Tests for Add detector for publicly accessible cloud storage buckets."""

from __future__ import annotations


class TestDetectorPubliclyAccessibleCloudStorageBuckets:
    """Unit tests for DetectorPubliclyAccessibleCloudStorageBuckets."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from detectors.storage.public_access_detector import (
            DetectorPubliclyAccessibleCloudStorageBuckets,
        )

        scanner = DetectorPubliclyAccessibleCloudStorageBuckets()
        config = {
