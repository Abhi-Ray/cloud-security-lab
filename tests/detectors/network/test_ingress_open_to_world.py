"""Tests for Add Detector for Overly Permissive Ingress Rules (SSH/RDP Open to 0.0.0.0/0)."""

from __future__ import annotations


class TestDetectorOverlyPermissiveIngressRulesSshrdpOpenTo00000:
    """Unit tests for DetectorOverlyPermissiveIngressRulesSshrdpOpenTo00000."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from detectors.network.ingress_open_to_world import (
            DetectorOverlyPermissiveIngressRulesSshrdpOpenTo00000,
        )

        scanner = DetectorOverlyPermissiveIngressRulesSshrdpOpenTo00000()
        config = {
