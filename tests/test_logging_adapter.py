"""Tests for Add structured JSON logging adapter."""

from __future__ import annotations


class TestStructuredJsonLoggingAdapter:
    """Unit tests for StructuredJsonLoggingAdapter."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from security_scanner.logging_adapter import StructuredJsonLoggingAdapter

        scanner = StructuredJsonLoggingAdapter()
        config = {
