"""Tests for Add detector for hardcoded AWS credentials in source code."""

from __future__ import annotations


class TestDetectorHardcodedAwsCredentialsInSourceCode:
    """Unit tests for DetectorHardcodedAwsCredentialsInSourceCode."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from detectors.aws_credential_detector import DetectorHardcodedAwsCredentialsInSourceCode

        scanner = DetectorHardcodedAwsCredentialsInSourceCode()
        config = {
