"""Tests for Add AWS RDS security scanner."""

from __future__ import annotations


class TestAwsRdsSecurityScanner:
    """Unit tests for AwsRdsSecurityScanner."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from security_scanner.scanners.rds_scanner import AwsRdsSecurityScanner

        scanner = AwsRdsSecurityScanner()
        config = {
