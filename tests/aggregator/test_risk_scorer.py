"""Tests for Implement Unified Finding Aggregator with Correlation Engine."""

from __future__ import annotations


class TestUnifiedFindingAggregatorCorrelationEngine:
    """Unit tests for UnifiedFindingAggregatorCorrelationEngine."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from aggregator.risk_scorer import UnifiedFindingAggregatorCorrelationEngine

        scanner = UnifiedFindingAggregatorCorrelationEngine()
        config = {
