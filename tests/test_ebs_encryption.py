"""Tests for Add EBS Volume Encryption Detector."""

from __future__ import annotations


class TestEbsVolumeEncryptionDetector:
    """Unit tests for EbsVolumeEncryptionDetector."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from detectors.ebs_encryption import EbsVolumeEncryptionDetector

        scanner = EbsVolumeEncryptionDetector()
        config = {
