"""Tests for Implement Infrastructure-as-Code (Terraform) Security Scanning Capability."""

from __future__ import annotations


class TestInfrastructureAsCodeTerraformSecurityScanningCapability:
    """Unit tests for InfrastructureAsCodeTerraformSecurityScanningCapability."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from detectors.iac.terraform_detector import (
            InfrastructureAsCodeTerraformSecurityScanningCapability,
        )

        scanner = InfrastructureAsCodeTerraformSecurityScanningCapability()
        config = {
