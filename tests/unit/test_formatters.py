"""Tests for Implement Unified Multi-Format Reporting Engine."""

from __future__ import annotations


class TestUnifiedMultiFormatReportingEngine:
    """Unit tests for UnifiedMultiFormatReportingEngine."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from security_scanner.reporting.formatters.sarif_formatter import (
            UnifiedMultiFormatReportingEngine,
        )

        scanner = UnifiedMultiFormatReportingEngine()
        config = {
