"""Tests for Add detector for publicly accessible RDS snapshots."""

from __future__ import annotations


class TestDetectorPubliclyAccessibleRdsSnapshots:
    """Unit tests for DetectorPubliclyAccessibleRdsSnapshots."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from detectors.rds_snapshot_detector import DetectorPubliclyAccessibleRdsSnapshots

        scanner = DetectorPubliclyAccessibleRdsSnapshots()
        config = {
