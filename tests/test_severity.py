"""Tests for Add severity enum and risk-scoring utility."""

from __future__ import annotations


class TestSeverityEnumAndRiskScoringUtility:
    """Unit tests for SeverityEnumAndRiskScoringUtility."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from security_scanner.severity import SeverityEnumAndRiskScoringUtility

        scanner = SeverityEnumAndRiskScoringUtility()
        config = {
