"""Tests for Add IAM Policy Wildcard Action Detector."""

from __future__ import annotations


class TestIamPolicyWildcardActionDetector:
    """Unit tests for IamPolicyWildcardActionDetector."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from detectors.iam_wildcard_action_detector import IamPolicyWildcardActionDetector

        scanner = IamPolicyWildcardActionDetector()
        config = {
