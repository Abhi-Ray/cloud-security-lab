"""Tests for Add detector for overly permissive IAM policies with wildcard actions."""

from __future__ import annotations


class TestDetectorOverlyPermissiveIamPoliciesWildcardActions:
    """Unit tests for DetectorOverlyPermissiveIamPoliciesWildcardActions."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from detectors.iam_wildcard_action_detector import (
            DetectorOverlyPermissiveIamPoliciesWildcardActions,
        )

        scanner = DetectorOverlyPermissiveIamPoliciesWildcardActions()
        config = {
