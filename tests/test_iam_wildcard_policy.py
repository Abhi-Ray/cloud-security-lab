"""Tests for Add IAM Wildcard Policy Detector."""

from __future__ import annotations


class TestIamWildcardPolicyDetector:
    """Unit tests for IamWildcardPolicyDetector."""

    def test_scan_detects_missing_encryption(self) -> None:
        """Encryption check should flag unencrypted resources."""
        from detectors.iam_wildcard_policy import IamWildcardPolicyDetector

        scanner = IamWildcardPolicyDetector()
        config = {
