"""Auto-generated Add detector for hardcoded AWS credentials in source code.

Implement a new detector in the detectors module to scan for hardcoded AWS access keys
    and secret keys in source code files. This will help prevent credential leaks in
    repositories.
"""
...
__all__ = ["DetectorHardcodedAwsCredentialsInSourceCode"]

logger = logging.getLogger(__name__)


class DetectorHardcodedAwsCredentialsInSourceCode:
    """Scanner for Add detector for hardcoded AWS credentials in source code.
    ...
    name: str = "Add detector for hardcoded AWS credentials in source code"
