"""Auto-generated Add IAM privilege escalation detector.

Detect dangerous IAM policy combinations that allow privilege escalation
    (iam:CreatePolicyVersion, iam:AttachUserPolicy, etc.).
"""
...
__all__ = ["IamPrivilegeEscalationDetector"]
...
@dataclass
class IamPrivilegeEscalationDetector:
    """Detection rule for Add IAM privilege escalation detector.
