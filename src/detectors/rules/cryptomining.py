"""Auto-generated Add crypto-mining activity detector.

Detect EC2 instance types and utilisation patterns that indicate cryptocurrency mining
    abuse.
"""
...
__all__ = ["CryptoMiningActivityDetector"]
...
@dataclass
class CryptoMiningActivityDetector:
    """Detection rule for Add crypto-mining activity detector.
