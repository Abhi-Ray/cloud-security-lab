"""Auto-generated Add CloudTrail anomaly detector.

Analyse CloudTrail mock events for unusual API call patterns, off-hours access, and
...
class CloudtrailAnomalyDetector:
    """Detection rule for Add CloudTrail anomaly detector.
