...
Implement a new detector module that identifies publicly accessible storage buckets across AWS S3, Azure Blob Storage, and GCP Cloud Storage. The detector will analyze bucket policies, ACLs, and IAM bindings to flag misconfigurations that expose sensitive data. Includes unit tests and documentation.
"""
