"""Auto-generated Add multi-cloud storage bucket public access detector.

Implement a new detector in the detectors module that identifies storage buckets (AWS
    S3, Azure Blob Storage, GCP Cloud Storage) with public read/write access. The
    detector should integrate with the existing security_scanner and compliance modules,
...
__all__ = ["MultiCloudStorageBucketPublicAccessDetector"]

logger = logging.getLogger(__name__)


class MultiCloudStorageBucketPublicAccessDetector:
    """Scanner for Add multi-cloud storage bucket public access detector.
    ...
    name: str = "Add multi-cloud storage bucket public access detector"
