"""Auto-generated Add IAM Policy Analyzer Detector for Overly Permissive Roles.

Implement a new detector in the 'detectors' module that analyzes IAM policies (AWS, GCP,
    Azure) for overly permissive roles, such as wildcard actions (*:*) on sensitive
    resources, missing condition keys, and excessive principal permissions. The detector
    should output findings in a standardized format compatible with the existing
    security_scanner reporting pipeline. Includes unit tests and integration test
    fixtures.
"""
...
__all__ = ["IamPolicyAnalyzerDetectorOverlyPermissiveRoles"]

logger = logging.getLogger(__name__)


class IamPolicyAnalyzerDetectorOverlyPermissiveRoles:
    """Scanner for Add IAM Policy Analyzer Detector for Overly Permissive Roles.
    ...
    name: str = "Add IAM Policy Analyzer Detector for Overly Permissive Roles"
