"""Auto-generated Add IAM Wildcard Policy Detector.

Implement a new detector to identify IAM policies with wildcard (*) actions or resources
    that grant excessive permissions. Includes unit tests and compliance mapping to CIS
...
__all__ = ["IamWildcardPolicyDetector"]

logger = logging.getLogger(__name__)


class IamWildcardPolicyDetector:
    """Scanner for Add IAM Wildcard Policy Detector.
    ...
    name: str = "Add IAM Wildcard Policy Detector"
