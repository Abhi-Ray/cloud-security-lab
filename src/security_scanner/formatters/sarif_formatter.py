"""Auto-generated Add SARIF output support for security scanner.

Implement a SARIF (Static Analysis Results Interchange Format) formatter to enable
    integration with GitHub Code Scanning, GitLab SAST, and other SARIF-compatible
    tools. This includes creating a new formatter module, registering it in the output
    factory, and adding unit tests for the formatter.
"""
...
__all__ = ["SarifOutputSupportSecurityScanner"]

logger = logging.getLogger(__name__)


class SarifOutputSupportSecurityScanner:
    """Scanner for Add SARIF output support for security scanner.
    ...
    name: str = "Add SARIF output support for security scanner"
