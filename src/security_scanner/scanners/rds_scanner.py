"""Auto-generated Add AWS RDS security scanner.

Implement scanner for RDS instances checking encryption at rest, public accessibility,
    automated backups, and IAM authentication.
"""
...
__all__ = ["AwsRdsSecurityScanner"]

logger = logging.getLogger(__name__)


class AwsRdsSecurityScanner:
    """Scanner for Add AWS RDS security scanner.

    Implement scanner for RDS instances checking encryption at rest, public accessibility,
    automated backups, and IAM authentication.
    """

    name: str = "Add AWS RDS security scanner"
