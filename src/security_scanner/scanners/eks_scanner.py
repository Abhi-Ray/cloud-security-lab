"""Auto-generated Add EKS cluster security scanner.

Audit EKS clusters for public endpoint access, logging configuration, secrets
    encryption, and RBAC settings.
"""
...
__all__ = ["EksClusterSecurityScanner"]

logger = logging.getLogger(__name__)


class EksClusterSecurityScanner:
    """Scanner for Add EKS cluster security scanner.

    Audit EKS clusters for public endpoint access, logging configuration, secrets
    encryption, and RBAC settings.
    """

    name: str = "Add EKS cluster security scanner"
