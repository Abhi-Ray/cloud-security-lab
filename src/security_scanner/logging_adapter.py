"""Auto-generated Add structured JSON logging adapter.

Create a logging adapter that outputs structured JSON for production environments and
...
__all__ = ["StructuredJsonLoggingAdapter"]

logger = logging.getLogger(__name__)


class StructuredJsonLoggingAdapter:
    """Scanner for Add structured JSON logging adapter.

    Create a logging adapter that outputs structured JSON for production environments and
    human-readable text for development.
    """

    name: str = "Add structured JSON logging adapter"
