"""Auto-generated Implement Infrastructure-as-Code (Terraform) Security Scanning Capability.
...
__all__ = ["InfrastructureAsCodeTerraformSecurityScanningCapability"]

logger = logging.getLogger(__name__)


class InfrastructureAsCodeTerraformSecurityScanningCapability:
    """Scanner for Implement Infrastructure-as-Code (Terraform) Security Scanning Capability.
    ...
    name: str = "Implement Infrastructure-as-Code (Terraform) Security Scanning Capability"
    ...
    def _check_encryption(self, config: dict[str, Any]) -> list[Finding]:
        ...
        if not config.get("encryption_enabled", False):
            findings.append(
                Finding(
                    id="IACTERRAFORMSCANNING001-001",
    ...
    def _check_public_access(self, config: dict[str, Any]) -> list[Finding]:
        ...
        if config.get("publicly_accessible", False):
            findings.append(
                Finding(
                    id="IACTERRAFORMSCANNING001-002",
    ...
    def _check_logging(self, config: dict[str, Any]) -> list[Finding]:
        ...
        if not config.get("logging_enabled", False):
            findings.append(
                Finding(
                    id="IACTERRAFORMSCANNING001-003",
